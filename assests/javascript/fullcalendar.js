                        ...
                        (t.parse = function(e, n) {
                            ...
                            return (!!s.isValid() &&
                                (!a || (a.isValid() && a.isAfter(s)) || (a = null),
                                    null == l && null == (l = n.allDayDefault) && (l = o.opt("allDayDefault")), !0 === l ? (s.stripTime(), a && a.stripTime()) : !1 === l && (s.hasTime() || s.time(0), a && !a.hasTime() && a.time(0)), !a && u && (a = o.getDefaultEventEnd(!s.hasTime(), s)),
                                    new t(s, a, o))
                            );
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.buildNewDateProfile = function(t, e) {
                            ...
                            return (
                                ...
                                o && ((n = e.applyTimezone(n)), i && (i = e.applyTimezone(i))), !i && e.opt("forceEventDuration") && (i = e.getDefaultEventEnd(t.isAllDay(), n)),
                                new r.default(n, i, e)
                            );
                        }),
                ...
                s = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.updateDayTable = function() {
                            for (
                                var t, e, n, i = this, r = i.view, o = r.calendar, s = o.msToUtcMoment(i.dateProfile.renderUnzonedRange.startMs, !0), a = o.msToUtcMoment(i.dateProfile.renderUnzonedRange.endMs, !0), l = -1, u = [], d = []; s.isBefore(a);
                        ...
                        (e.prototype.computeColHeadFormat = function() {
                            return this.rowCnt > 1 || this.colCnt > 10 ? "dddd" : this.colCnt > 1 ? this.opt("dayOfMonthFormat") : "dddd";
                        }),
                        // Hard code DDDD
                    ...
                    return (
                        ...
                        (t.prototype.buildCurrentRangeInfo = function(t, e) {
                            ...
                            return (
                                ...
                                ((o = this.getFallbackDuration()), (s = r.computeGreatestUnit(o)), (a = this.buildRangeFromDuration(t, e, o, s))), { duration: o, unit: s, unzonedRange: a }
                            );
                        }),
