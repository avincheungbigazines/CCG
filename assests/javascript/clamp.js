    ...
    return (
        (t.prototype.restore = function () {
            ...
            this.unwatch(),
                ...
                this.container.classList.remove("cus-truncated"),
        ...
        (t.prototype.truncate = function () {
            ...
            return (
                ...
                this.container.classList[e ? "add" : "remove"]("cus-truncated"),
        ...
        (t.prototype._truncateToNode = function (e) {
            ...
            if (
                (t.$.contents(e).forEach(function (t) {
                    if (1 != t.nodeType || !t.matches(".cus-keep")) {
